  ...
  return (
    <div className="h-full hidden sm:flex flex-col fixed xl:ml-24">
      <nav className="h-full relative xl:space-y-1.5">
        ...
        <button className="hidden cursor-not-allowed xl:inline bg-[#1d9bf0] rounded-full mt-2 h-[52px] w-[200px] text-lg font-bold ">
          Tweet
        </button>
        <div
          onClick={handleSignOut}
          className="absolute flex xl:p-3 justify-center items-center space-x-3 hover:bg-white hover:bg-opacity-10 rounded-full cursor-pointer bottom-0"
        >
          <img
